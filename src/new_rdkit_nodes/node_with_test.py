...
ktest.register_extension(
    "/Users/chaubold/src/knime-chemistry/org.knime.chem.types/plugin.xml"
)
...
class TestCase(unittest.TestCase):
    def test_node_configure(self):
        ...
        self.assertEqual(
            expected_schema,
            output_schema.get(),  # need to call get because append of the schema in
            # configure() returns a view. Our backend calls get() automatically if needed
        )
